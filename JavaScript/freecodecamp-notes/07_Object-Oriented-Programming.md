...
Code Assignement: The eat method is repeated in both Cat and Bear. Edit the code in the spirit of DRY by moving the eat method to the Animal supertype.

[My Code](https://github.com/EO4wellness/T-I-L/blob/main/JavaScript/freecodecamp-exercises/07.ObjectOrientedProgramming/17_use-inheritance-so-you-dont-repeat-yourself.js)
...
Code Assignement: Use Object.create to make two instances of Animal named duck and beagle.

[My Code](https://github.com/EO4wellness/T-I-L/blob/main/JavaScript/freecodecamp-exercises/07.ObjectOrientedProgramming/18_inherit-behaviors-from-a-supertype.js)


## 19 [Set the Child's Prototype to an Instance of the Parent](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/object-oriented-programming/set-the-childs-prototype-to-an-instance-of-the-parent) 

Notes:  In the previous challenge you saw the first step for inheriting behavior from the supertype (or parent) Animal: making a new instance of Animal.
...
Code Assignement: Modify the code so that instances of Dog inherit from Animal.

[My Code](https://github.com/EO4wellness/T-I-L/blob/main/JavaScript/freecodecamp-exercises/07.ObjectOrientedProgramming/19_set-the-childs-prototype-to-an-instance-of-the-parent.js)


## 20 [Reset an Inherited Constructor Property](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/object-oriented-programming/reset-an-inherited-constructor-property) 

Notes:  When an object inherits its prototype from another object, it also inherits the supertype's constructor property.
...
Code Assignement: Fix the code so duck.constructor and beagle.constructor return their respective constructors.

[My Code](https://github.com/EO4wellness/T-I-L/blob/main/JavaScript/freecodecamp-exercises/07.ObjectOrientedProgramming/20_reset-an-inherited-constructor-property.js)
...
Notes: In previous lessons, you learned that an object can inherit its behavior (methods) from another object by referencing its prototype object:
```
...
Code Assignement: Override the fly() method for Penguin so that it returns the string Alas, this is a flightless bird.

[My Code](https://github.com/EO4wellness/T-I-L/blob/main/JavaScript/freecodecamp-exercises/07.ObjectOrientedProgramming/22_override-inherited-methods.js)


## 23 [Use a Mixin to Add Common Behavior Between Unrelated Objects](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/object-oriented-programming/use-a-mixin-to-add-common-behavior-between-unrelated-objects) 
...
Code Assignement: Create a mixin named glideMixin that defines a method named glide. Then use the glideMixin to give both bird and boat the ability to glide.

[My Code](https://github.com/EO4wellness/T-I-L/blob/main/JavaScript/freecodecamp-exercises/07.ObjectOrientedProgramming/23_use-a-mixin-to-add-common-behavior-between-unrelated-objects.js)


## 24 [Use Closure to Protect Properties Within an Object from Being Modified Externally](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/object-oriented-programming/use-closure-to-protect-properties-within-an-object-from-being-modified-externally) 

Notes:  In the previous challenge, bird had a public property name. It is considered public because it can be accessed and changed outside of bird's definition.
```
bird.name = "Duffy";
```
...
Code Assignement: Change how weight is declared in the Bird function so it is a private variable. Then, create a method getWeight that returns the value of weight 15.

[My Code](https://github.com/EO4wellness/T-I-L/blob/main/JavaScript/freecodecamp-exercises/07.ObjectOrientedProgramming/24_use-closure-to-protect-properties-within-an-object-from-being-modified-externally.js)


## 25 [Understand the Immediately Invoked Function Expression (IIFE)](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/object-oriented-programming/understand-the-immediately-invoked-function-expression-iife) 
...
Code Assignement: Rewrite the function ```makeNest``` and remove its call so instead it's an anonymous immediately invoked function expression (IIFE).

[My Code](https://github.com/EO4wellness/T-I-L/blob/main/JavaScript/freecodecamp-exercises/07.ObjectOrientedProgramming/25_understand-the-immediately-invoked-function-expression-iife.js)


## 26 [Use an IIFE to Create a Module](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/object-oriented-programming/use-an-iife-to-create-a-module) 

Notes:   An immediately invoked function expression (IIFE) is often used to group related functionality into a single object or module. For example, an earlier challenge defined two mixins:
```
...
Code Assignement: Create a module named funModule to wrap the two mixins isCuteMixin and singMixin. funModule should return an object.

[My Code](https://github.com/EO4wellness/T-I-L/blob/main/JavaScript/freecodecamp-exercises/07.ObjectOrientedProgramming/26_use-an-iife-to-create-a-module.js)

# End of Study
![End of Study Course](https://github.com/EO4wellness/T-I-L/blob/main/JavaScript/Images/2021-07-31-finished-FCC-ObjectOrientedProgramming.jpg)

Completed this segment's study July 31, 2021

NEXT: [Functional Programming](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/#functional-programming)
